...
Treat manual_evidence_context as evidence extracted from user-provided logs, metrics, alerts, and feedback.
Prefer hypotheses that connect log patterns, metric changes, retrieved knowledge, and manual evidence.
